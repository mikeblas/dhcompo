...
curl --silent -o docker-compose.yml https://raw.githubusercontent.com/mikeblas/dhcompo/main/docker-compose.yml
curl --silent -o .env https://raw.githubusercontent.com/mikeblas/dhcompo/main/.env
